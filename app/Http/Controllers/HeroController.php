...
class HeroController extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request->hasFile('image')) {
            ...
            Image::make('assets/uploads/hero/'.$imageFileName)->resize(800,600)->save('assets/uploads/hero/'.$imageFileName);
        } else {
    ...
    public function update(Request $request, Hero $hero)
    {
        ...
        if ($request->hasFile('image')){
            ...
            Image::make('assets/uploads/hero/'.$heroImageFileName)->resize(800,600)->save('assets/uploads/hero/'.$heroImageFileName);
        }

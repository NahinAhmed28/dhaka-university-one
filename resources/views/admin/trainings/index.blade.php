                    ...
                    @foreach($trainings as $training)
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ route('training.destroy' ,  [$training->id]) }}" accept-charset="UTF-8" style="display:inline">
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" class="btn btn-danger btn-sm" title="Delete training"

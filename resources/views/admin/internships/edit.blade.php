...
@section('content')
    ...
    <div class="main-card mb-3 card">
        <div class="card-body table-full-width table-responsive">
            <h4> <strong class="text-bg-primary">Internship Edit</strong></h4>
            <!--begin::Form-->
                    ...
                    <div class="row col-md-6">
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <div class="form-group  m-form__group {{ $errors->has('title') ? 'has-danger' : '' }}">
                                ...
                                <textarea class="form-control" id="title" placeholder="" rows="3" name="title" cols="50">{{ old('title', $internship->title) }}</textarea>
                                @if ($errors->has('title'))
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <div class="form-group  m-form__group {{ $errors->has('description') ? 'has-danger' : '' }}">
                                ...
                                <textarea class="form-control" id="description" placeholder="" rows="3" name="description" cols="50">{{ old('description', $internship->description) }}</textarea>
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <img class="img-thumbnail" src="{{ asset('assets/uploads/internship/'.$internship->image)}}" width="200px">
                        ...
                        <div class="m-portlet__foot m-portlet__foot--fit">
                            <div class="m-form__actions text-center">
                                <a href="{{ route('internship.index') }}" class="btn btn-outline-warning"><i class="fa fa-times"></i> Cancel</a>

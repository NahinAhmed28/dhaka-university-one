                ...
                <div class="row col-md-6">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group  m-form__group {{ $errors->has('email') ? 'has-danger' : '' }}">
                            ...
                            <textarea class="form-control" id="email" placeholder="" rows="3" name="email" cols="50">{{
                                old('email', $data->email) }}</textarea>
                            @if ($errors->has('email'))
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group  m-form__group {{ $errors->has('phone') ? 'has-danger' : '' }}">
                            ...
                            <textarea class="form-control" id="phone" placeholder="" rows="3" name="phone" cols="50">{{
                                old('phone', $data->phone) }}</textarea>
                            @if ($errors->has('phone'))
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group  m-form__group {{ $errors->has('address') ? 'has-danger' : '' }}">
                            ...
                            <textarea class="form-control" id="address" placeholder="" rows="3" name="address"
                                cols="50">{{ old('address', $data->address) }}</textarea>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group  m-form__group {{ $errors->has('message') ? 'has-danger' : '' }}">
                            ...
                            <textarea class="form-control" id="message" placeholder="" rows="3" name="message"
                                cols="50">{{ old('message', $data->message) }}</textarea>
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions text-center flexbox">
                            <a href="{{ route('contact.index') }}" class="btn btn-danger btn-flex"><i

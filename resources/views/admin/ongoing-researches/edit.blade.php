...
@section('content')
    ...
    <div class="main-card mb-3 card">
        <div class="card-body table-full-width table-responsive">
            <h4> <strong class="text-bg-primary">Ongoing Research Edit</strong></h4>
            <!--begin::Form-->
                    ...
                    <div class="row col-md-6">
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <div class="form-group  m-form__group {{ $errors->has('title') ? 'has-danger' : '' }}">
                                ...
                                <textarea class="form-control" id="title" placeholder="" rows="3" name="title" cols="50">{{ old('title', $data->title) }}</textarea>
                                @if ($errors->has('title'))
                        ...
                        <div class="m-portlet__foot m-portlet__foot--fit">
                            <div class="m-form__actions text-center">
                                <a href="{{ route('ongoing-research.index') }}" class="btn btn-outline-warning"><i class="fa fa-times"></i> Cancel</a>
